...
export default function sideBar (props) {
    return (
        <div className={styles.sidebar + ' ' + (props.show ? styles.show : '')}>
            <ul>
                <button onClick={props.toogleSidebar} className={styles["fecharmenu"]}><img srcSet="/assets/Icon/fechar.svg" id={styles.icon} alt="Fechar" /></button>
                ...
                <li>
                    <Link href="/login" >
                        <a className={styles["btnloginsidebar"]}>
                            <img srcSet="/assets/Icon/user.svg" id={styles.icon} alt="Usuário"/>
                        </a>
                    </Link>
                </li>
            </ul>
